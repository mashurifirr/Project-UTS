  ...
  <div class="card tw-mx-auto !tw-max-w-2xl tw-shadow-lg">
    <div class="card-body">
      ...
      <div class="tw-col-span-6">
        ...
        <input type="number" class="form-control @error('tahun_buka') is-invalid @enderror !tw-bg-gray-800"
      ...
      <div class="tw-col-span-6">
        ...
        <input type="number" class="form-control @error('harga_tiket') is-invalid @enderror !tw-bg-gray-800"
